  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        b = res.data.info.guest_id,
        c = res.data.info.price,
        d = res.data.info.id,
        snum = res.data.info.else_num,
        console.log(res.data.info.guest_id)
        wx.getStorage({
          key: 'openid',
          success: function (res) {
